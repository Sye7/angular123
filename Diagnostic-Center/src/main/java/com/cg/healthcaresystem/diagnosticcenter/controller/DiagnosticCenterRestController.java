 ...
 */
	...
	ResponseEntity<CenterDetailsDto> add(@Valid @RequestBody CenterDto reqDto) {
		...
		center.setContactNumber(reqDto.getContactNumber());
		center.setLocation(reqDto.getCenterLocation());
		center.setListOfTest(reqDto.getListOfTest());
 ...
 */
	...
	ResponseEntity<Boolean> delete(@PathVariable("centerId") Long centerId) {
 ...
 */
	...
	ResponseEntity<CenterDetailsDto> getById(@PathVariable("centerId") Long centerId) {
 ...
 */
	...
	ResponseEntity<CenterDetailsDto> modify(@PathVariable("centerId") Long centerId,
		...
		center.setLocation(dto.getCenterLocation());
		center.setListOfTest(dto.getListOfTest());
	...
	public CenterDetailsDto convertToDetailsDto(DiagnosticCenter center) {
		...
		dto.setCenterLocation(center.getLocation());
		dto.setListOfTest(center.getListOfTest());
		return dto;
	}
/**
 * 
